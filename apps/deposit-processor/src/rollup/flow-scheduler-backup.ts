...
import { BaseResponse, DepositStatus, L2TxStatus, ProofTaskDto, ProofTaskType, MerkleTreeId } from "@anomix/types";
...
import { DepositActionEventFetchRecord, DepositCommitment, DepositProverOutput, DepositTreeTrans, MemPlL2Tx } from "@anomix/dao";
...
export class FlowScheduler {
    ...
    async whenMergedResultComeBack(result: any) {
        ...
        try {
            ...
            // just like in parrallel, a 'depositProverOutput' invoke contract earlier than its predecessor and failed for the unconsistence with zkappStatus.
            ...
            await depositProverOutputRepo.save({
                output: result,
                transId: this.depositTreeTrans.id
