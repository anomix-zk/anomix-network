import { IndexedTreeLeafPreimage } from './indexed_tree_leaf';
...
export interface TreeSnapshot {
   ...
   */
  getLeafValue(index: bigint): Promise<bigint | undefined>;
   ...
   */
  findLeafIndex(value: bigint): Promise<bigint | undefined>;
}
