...
export const NULLIFIER_ACCOUNT_PREFIX = Field('20240101');
...
export const DEPOSIT_TREE_HEIGHT = 4;
export const DEPOSIT_TREE_INIT_ROOT = STANDARD_TREE_INIT_ROOT_4;
...
export const ROOT_TREE_INIT_ROOT = Field(
  '23559074018763753490950935905740633296471756733943111443021829326737094128619'
);
